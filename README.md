...
# QuickLook.Plugin.DumpBin

This plugin illustrates the development process of [QuickLook](https://github.com/QL-Win/QuickLook).

## Try out

1. Go to [Release page](https://github.com/QL-Win/QuickLook.Plugin.DumpBin/releases) and download the latest version.
...
## Development
 ...
 4. You should find a file named `QuickLook.Plugin.DumpBin.qlplugin` in the project directory.
